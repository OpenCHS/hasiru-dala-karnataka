...
SELECT 'Wife', uuid_generate_v4(), 1, create_audit((select id from users where username = 'admin@hasiru-karnataka')), false, id
from organisation
...
SELECT 'Husband',
       uuid_generate_v4(),
       1,
       create_audit((select id from users where username = 'admin@hasiru-karnataka')),
       false,
       id
from organisation
where name = 'Hasiru Dala Karnataka';
...
INSERT INTO individual_relation (name, uuid, version, audit_id, is_voided, organisation_id)
SELECT 'Son', uuid_generate_v4(), 1, create_audit((select id from users where username = 'admin@hasiru-karnataka')), false, id
from organisation
where name = 'Hasiru Dala Karnataka';
...
INSERT INTO individual_relation (name, uuid, version, audit_id, is_voided, organisation_id)
SELECT 'Son-in-law', uuid_generate_v4(), 1, create_audit((select id from users where username = 'admin@hasiru-karnataka')), false, id
from organisation
where name = 'Hasiru Dala Karnataka';
